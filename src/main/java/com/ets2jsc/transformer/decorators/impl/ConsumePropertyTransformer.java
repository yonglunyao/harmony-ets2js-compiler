...
/**
 * Transforms @Consume decorated properties.
 * <p>
 ...
 */
public class ConsumePropertyTransformer extends PropertyTransformer {
    ...
    protected boolean needsConstructorInit() {
        // Consume properties use declaration initializer
        return false;
    }

    @Override
    protected String getCreateMethodName() {
        return RuntimeFunctions.INITIALIZE_CONSUME_V2;
    }

    @Override
    public boolean canHandle(PropertyDeclaration prop) {
        return prop.hasDecorator(Decorators.CONSUME);
    }
}
