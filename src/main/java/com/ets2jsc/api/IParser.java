...
/**
 * Interface for parsing TypeScript/ETS source code into AST.
 * <p>
 * This is the primary facade for the ParserModule, providing a single
 * entry point for all parsing operations. Implementations should handle
 * file I/O, error handling, and AST construction internally.
 */
public interface IParser extends AutoCloseable {
     ...
     * Implementations should clean up any temporary files or processes.
     */
    @Override
    void close();
}
