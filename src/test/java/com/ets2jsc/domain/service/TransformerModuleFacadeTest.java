...
class TransformerModuleFacadeTest {
    ...
    void testTransformAppliesTransformersToSourceFile() throws CompilationException {
        // Arrange
    ...
    void testTransformNodeReturnsNodeForValidInput() throws CompilationException {
        // Arrange
        CompilerConfig config = CompilerConfig.createDefault();
        TransformerModuleFacade facade = new TransformerModuleFacade(config);
