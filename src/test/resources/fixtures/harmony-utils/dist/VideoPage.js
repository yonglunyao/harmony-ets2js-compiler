...
export class VideoPage extends View {
  ...
  initialRender() {
    ...
    Logger.error("获取时长失败", error);
          ...
          Text.pop();
                    ...
                    Row.create({space: 16});
            TextInput({placeholder: "截图时间点(毫秒)", text: `${this.captureTime}`}).type(InputType.Number).width(120).onChange((value) => {
  ...
  videoInfo__ = {width: 0, height: 0, duration: 0, durationFormatted: "", mimeType: ""};
